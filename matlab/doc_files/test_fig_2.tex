...
\draw[line width=0.5pt,color=black] plot file {test_fig_2_XY.dat};
...
\draw[line width=0.5pt,color=green,draw opacity=0.75] plot file {test_fig_2_err.dat};
...
\filldraw[line width=0.5pt,color=blue,fill=draw opacity=0.75] plot file {test_fig_2_hg.dat};
\end{tikzpicture}
