...
\draw[line width=0.5pt,color=black] plot file {test_fig_XY.dat};
...
\draw[->] (0,0) -- node[halfway,yshift=-0.75cm] {\footnotesize flow} (1,0);
\draw[->] (0,0) -- node[rotate=90,halfway,yshift=0.75cm] {\footnotesize loss} (0,1) ;
...
\draw[line width=0.5pt,color=green,draw opacity=0.75] plot file {test_fig_err.dat};
\foreach \y/\ytext in {0/-0.05,0.1/-0.04,0.2/-0.03,0.3/-0.02,0.4/-0.01,0.5/0.0,0.6/0.01,0.7/0.02,0.8/0.03,0.9/0.04,1.0/0.05}
